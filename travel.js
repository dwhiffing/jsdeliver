...
$(function () {
  window.cardify.loadScript('https://d2j940tllnytyh.cloudfront.net/cardify/index/data/industry.js').then((_data) => {
    ...
    const chart = window.cardify.showChart('#travel-graph-container', {
      ...
      data: {
        labels: [
          "02/02/20", "02/09/20", "02/16/20",
          "02/23/20", "03/01/20", "03/08/20",
          "03/15/20", "03/22/20", "03/29/20",
          "04/05/20", "04/12/20", "04/19/20",
          "04/26/20", "05/03/20", "05/10/20",
          "05/17/20", "05/24/20", "05/31/20",
          "06/07/20", "06/14/20", "06/21/20",
          "06/28/20", "07/05/20"
        ],
